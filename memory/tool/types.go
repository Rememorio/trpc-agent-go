...
type SearchMemoryRequest struct {
	...
	OrderByEventTime bool   `json:"order_by_event_time,omitempty" jsonschema:"description=When true, use event_time ascending as a tie-breaker after relevance ranking. Useful for temporal sequence questions (what happened first/next/after)."`
}
