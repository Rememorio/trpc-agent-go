...
const (
	...
	assistantResultCompletenessUserSuffix = "Re-check the structured assistant " +
		"response above and store only concrete requested results needed to " +
		"preserve exact values identified as missing in the verification context."
)
...
func isAssistantResultCompletenessRecovery(
	...
	return len(existingResults) > 0 && !evidence.empty()
}
