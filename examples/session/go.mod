...
replace (
	...
	trpc.group/trpc-go/trpc-agent-go/session/mongodb => ../../session/mongodb
	...
	trpc.group/trpc-go/trpc-agent-go/storage/mongodb => ../../storage/mongodb
...
require (
	...
	trpc.group/trpc-go/trpc-agent-go/session/mongodb v0.0.0-20260622021948-09c728f1fb37
