...
func (e *AgenticEvaluator) evaluateQA(
	...
	if len(qaContextMsgs) > 0 {
		runOpts = append(runOpts,
			agent.WithInjectedContextMessages(qaContextMsgs),
		)
	}
